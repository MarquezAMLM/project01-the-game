...
class Cookie extends Sprite {
    constructor() {
        ...
        if (this.sprite) {
            ...
            this.sprite.style.backgroundImage = "../images/game.sprite.cookie.nobg.png";
        }
    }
    fallDown() {
...
class Raindrop extends Sprite {
    constructor() {
        ...
        if (this.sprite) {
            ...
            this.sprite.style.backgroundImage = "../images/game.sprite.raindrop.nobg.png";
        }
    }
    fallDown() {
        if (this.positionY > 0 - this.height) {
...
class Poop extends Sprite {
    constructor() {
        ...
        if (this.sprite) {
            ...
            this.sprite.style.backgroundImage = "../images/game.sprite.poop.nobg.png";
        }
    }
    fallDown() {
        if (this.positionY > 0 - this.height) {
